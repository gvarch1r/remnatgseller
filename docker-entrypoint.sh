...
ASSETS_CONTAINER_PATH="/opt/remnatgseller/assets"
ASSETS_DEFAULT_PATH="/opt/remnatgseller/assets.default"
...
if [ "$UVICORN_RELOAD_ENABLED" = "true" ]; then
    ...
    UVICORN_RELOAD_ARGS="--reload --reload-dir /opt/remnatgseller/src --reload-dir /opt/remnatgseller/assets --reload-include *.ftl"
else
