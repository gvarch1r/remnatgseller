...
class GetMetadataResponseDto(BaseModel):
    """Get system metadata response (API 2.5.0+)"""

    version: str = ""
    backend_commit_sha: Optional[str] = Field(None, alias="backendCommitSha")
    frontend_commit_sha: Optional[str] = Field(None, alias="frontendCommitSha")
