...
# Values must match API (integer vat_code), not enum member order.
class YookassaVatCode(IntEnum):
    VAT_CODE_01 = 1  # Без НДС
    VAT_CODE_02 = 2  # НДС 0%
    VAT_CODE_03 = 3  # НДС 10%
    VAT_CODE_04 = 4  # НДС 20%
    VAT_CODE_05 = 5  # НДС расчётная ставка 10/110
    VAT_CODE_06 = 6  # НДС расчётная ставка 20/120
    VAT_CODE_07 = 7  # НДС 5%
    VAT_CODE_08 = 8  # НДС 7%
    VAT_CODE_09 = 9  # НДС расчётная ставка 5/105
    VAT_CODE_10 = 10  # НДС расчётная ставка 7/107
    VAT_CODE_11 = 11  # НДС 22% (с 01.01.2026)
    VAT_CODE_12 = 12  # НДС расчётная ставка 22/122
