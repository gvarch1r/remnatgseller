...
class DashboardRemnatgseller(StatesGroup):
    MAIN = State()
    ADMINS = State()
    ADVERTISING = State()


class RemnatgsellerReferral(StatesGroup):
    MAIN = State()
    LEVEL = State()
    REWARD = State()
    REWARD_TYPE = State()
...
class RemnatgsellerGateways(StatesGroup):
    MAIN = State()
    SETTINGS = State()
    FIELD = State()
    CURRENCY = State()
...
class RemnatgsellerNotifications(StatesGroup):
    MAIN = State()
    USER = State()
    SYSTEM = State()
