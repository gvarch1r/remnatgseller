...
from src.bot.routers.dashboard.remnatgseller.referral.getters import (
...
from src.bot.routers.dashboard.remnatgseller.referral.handlers import (
...
from src.bot.states import DashboardRemnatgseller, RemnatgsellerReferral
...
referral = Window(
    ...
    Row(
        SwitchTo(
            ...
            id="level",
            state=RemnatgsellerReferral.LEVEL,
        ),
        SwitchTo(
            text=I18nFormat("btn-referral-reward-type"),
            id="reward_type",
            state=RemnatgsellerReferral.REWARD_TYPE,
        ),
    ),
    Row(
        SwitchTo(
            ...
            id="accrual_strategy",
            state=RemnatgsellerReferral.ACCRUAL_STRATEGY,
        ),
    ),
    Row(
        SwitchTo(
            ...
            id="reward_strategy",
            state=RemnatgsellerReferral.REWARD_STRATEGY,
        ),
    ),
    Row(
        SwitchTo(
            ...
            id="reward",
            state=RemnatgsellerReferral.REWARD,
        ),
    ),
    Row(
        Start(
