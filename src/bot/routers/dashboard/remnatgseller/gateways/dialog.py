...
from src.bot.states import DashboardRemnatgseller, RemnatgsellerGateways
...
gateways = Window(
    ...
    Row(
        SwitchTo(
            ...
            id="placement",
            state=RemnatgsellerGateways.PLACEMENT,
        ),
    ),
    Row(
        SwitchTo(
            ...
            id="default_currency",
            state=RemnatgsellerGateways.CURRENCY,
        ),
    ),
    Row(
        Start(
...
gateway_settings = Window(
    ...
    IgnoreUpdate(),
    state=RemnatgsellerGateways.SETTINGS,
...
gateway_field = Window(
    ...
    IgnoreUpdate(),
    state=RemnatgsellerGateways.FIELD,
    getter=field_getter,
)
