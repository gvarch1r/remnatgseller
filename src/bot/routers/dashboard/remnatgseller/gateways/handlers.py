...
from src.bot.states import RemnatgsellerGateways
...
async def on_gateway_select(
    ...
    await sub_manager.switch_to(state=RemnatgsellerGateways.SETTINGS)
...
async def on_field_select(
    ...
    await dialog_manager.switch_to(state=RemnatgsellerGateways.FIELD)
...
async def on_field_input(
    ...
    if not gateway or not gateway.settings:
        await dialog_manager.switch_to(state=RemnatgsellerGateways.MAIN)
    ...
    await dialog_manager.switch_to(state=RemnatgsellerGateways.SETTINGS)
