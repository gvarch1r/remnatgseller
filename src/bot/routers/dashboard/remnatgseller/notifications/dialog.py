...
from src.bot.states import DashboardRemnatgseller, RemnatgsellerNotifications
...
notifications = Window(
    ...
    Row(
        SwitchTo(
            ...
            id="users",
            state=RemnatgsellerNotifications.USER,
        ),
    ),
    Row(
        SwitchTo(
            ...
            id="system",
            state=RemnatgsellerNotifications.SYSTEM,
        ),
    ),
    Row(
        Start(
