...
user = Window(
    ...
    Row(
        Button(
            text=I18nFormat("btn-user.quick-plus-7"),
            id="quick_ext_7",
            on_click=on_quick_extend_7,
            when=F["has_subscription"] & F["can_edit"],
        ),
        Button(
            text=I18nFormat("btn-user.quick-plus-30"),
            id="quick_ext_30",
            on_click=on_quick_extend_30,
            when=F["has_subscription"] & F["can_edit"],
        ),
        Button(
            text=I18nFormat("btn-user.quick-reset-traffic"),
            id="quick_reset_traffic",
            on_click=on_reset_traffic,
            when=F["has_subscription"] & F["can_edit"],
        ),
        Button(
            text=I18nFormat("btn-user.quick-toggle-active"),
            id="quick_toggle_active",
