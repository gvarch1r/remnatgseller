...
from src.bot.keyboards import get_remnatgseller_update_keyboard
...
REMOTE_VERSION_URL: Final[str] = (
    "https://raw.githubusercontent.com/gvarch1r/remnatgseller/main/src/__version__.py"
)
        ...
        if rv > lv:
            ...
            await notification_service.system_notify(
                ...
                payload=MessagePayload.not_deleted(
                    ...
                    reply_markup=get_remnatgseller_update_keyboard(),
                ),
            )
        elif rv == lv:
