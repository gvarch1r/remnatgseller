...
btn-user =
    ...
    .quick-plus-7 = ⏩ +7 дн.
    .quick-plus-30 = ⏩ +30 дн.
    .quick-reset-traffic = 🔄 Сброс трафика
    .quick-toggle-active = ⏯ Вкл/выкл подписку
...
btn-gateway =
    ...
    .currency-rates = 💱 Авто-курсы (из ₽)
    .currency-rates-stars = ★ Звёзд на 1 USD
    .currency-rates-override = ₽ Фикс курс за $1
    .currency-rates-clear-override = ↩️ Сбросить фикс (ЦБ)
...
btn-subscription =
    ...
    .renew = 🔄 Продлить
    .change = 🔃 Изменить
    .add-devices = 📱 Докупить устройства
    .addon = +{ $device_count } устройств | { $final_amount -> 
    [0] 🎁
    *[HAS] { $final_amount }{ $currency }
    }
    .back-addon = ⬅️ Назад к выбору пакета
    .promocode = 🎟 Активировать промокод
    .invite-friend = 👥 Пригласить друга (реферальная программа)
...
btn-promocode =
    ...
    .allowed = 👥 Разрешенные пользователи
    .confirm = ✅ Сохранить
    .subscription-plan = 🔗 Выбрать план
    .activations = 🔢 Лимит активаций
...
btn-promocodes-list = 📃 Список
btn-promocodes-search = 🔍 Поиск
