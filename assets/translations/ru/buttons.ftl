...
# RemnatgSeller
btn-remnatgseller-release-latest = 👀 Посмотреть
btn-remnatgseller-how-upgrade = ❓ Как обновить
btn-remnatgseller-github = ⭐ GitHub
btn-remnatgseller-telegram = 👪 Telegram
btn-remnatgseller-donate = 💰 Поддержать разработчика
btn-remnatgseller-guide = ❓ Инструкция
...
btn-dashboard-remnatgseller = 🛍 RemnatgSeller
...
btn-user-sync-remnatgseller = 🛍 Использовать данные RemnatgSeller
...
# RemnatgSeller
btn-remnatgseller-admins = 👮‍♂️ Администраторы
btn-remnatgseller-gateways = 🌐 Платежные системы
