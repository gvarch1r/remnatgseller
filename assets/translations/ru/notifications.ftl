...
ntf-common =
    ...
    .rate-limited = ⚠️ <i>Слишком часто. Подождите несколько секунд и попробуйте снова.</i>
...
ntf-requirement =
    .channel-join-required =
        ❇️ <b>Шаг 1:</b> подпишитесь на канал (кнопка ниже).
        <b>Шаг 2:</b> вернитесь сюда и нажмите «Подтвердить».

        Бонусы в канале: акции и новости.
...
ntf-plan =
    ...
    .rates-unavailable = ❌ <i>Не удалось получить курс USD/₽. Проверьте сеть или задайте фикс курс в админке: Платёжные системы → Авто-курсы для цен.</i>
...
ntf-subscription =
    ...
    .addons-unavailable = ❌ <i>Нет доступных пакетов для докупки устройств.</i>
    .add-devices-not-applicable = ❌ <i>Докупка устройств доступна только при активной платной подписке с лимитом устройств (не в пробном периоде).</i>
    .renew-plan-unavailable = ❌ <i>Текущий план устарел и недоступен для продления.</i>
    .trial-renew-not-allowed = ❌ <i>Пробный период нельзя продлить. Оформите платную подписку — в меню подписки нажмите «Новая подписка».</i>
    .payment-creation-failed =
        ❌ <i>Не удалось открыть оплату. Попробуйте другой способ или повторите позже.</i>

        <i>Если ошибка повторяется — напишите в поддержку и укажите код: <code>{ $ref }</code></i>

ntf-promocode =
    .invalid-code = ❌ <i>Укажите код промокода.</i>
    .not-found = ❌ <i>Промокод не найден или неактивен.</i>
    .expired = ❌ <i>Срок действия промокода истёк.</i>
    .depleted = ❌ <i>Промокод исчерпан (достигнут лимит активаций).</i>
    .already-activated = ❌ <i>Вы уже активировали этот промокод.</i>
    .unsupported-type = ❌ <i>Этот тип промокода не поддерживается для активации в боте.</i>
    .subscription-plan-required = ❌ <i>Для этого промокода не задан план подписки.</i>
    .subscription-activate-failed = ❌ <i>Не удалось выдать подписку по промокоду. Попробуйте позже или обратитесь в поддержку.</i>
    .activated-success = ✅ <i>Промокод активирован! Скидка { $percent }% применена.</i>
    .subscription-activated-success = ✅ <i>Промокод активирован. Подписка: { $plan_name }.</i>

    .save-error = ❌ <i>Не удалось сохранить промокод. Попробуйте позже.</i>
    .code-exists = ❌ <i>Промокод с таким кодом уже есть.</i>
    .created-success = ✅ <i>Промокод создан.</i>
    .updated-success = ✅ <i>Промокод обновлён.</i>
    .deleted-success = ✅ <i>Промокод удалён.</i>
    .delete-failed = ❌ <i>Не удалось удалить промокод.</i>
    .search-empty = ❌ <i>Ничего не найдено.</i>
    .reward-invalid-number = ❌ <i>Введите целое неотрицательное число.</i>
    .reward-invalid-percent = ❌ <i>Введите процент от 0 до 100.</i>
    .lifetime-invalid = ❌ <i>Введите срок в днях: целое число ≥ -1 (-1 — без ограничения).</i>
    .activations-invalid = ❌ <i>Введите лимит: целое число ≥ -1 (-1 — без лимита).</i>
...
ntf-settings =
    .currency-rates-invalid = ❌ <i>Некорректное значение. Для сброса фикс-курса используйте кнопку или введите «-».</i>
