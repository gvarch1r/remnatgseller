...
ntf-event-bot-update =
    ...
    <b>🔅 Событие: Обнаружено обновление RemnatgSeller!</b>
...
ntf-promocode-save-error = <i>❌ Ошибка сохранения промокода.</i>
ntf-promocode-invalid-code = <i>❌ Укажите код промокода.</i>
ntf-promocode-code-exists = <i>❌ Промокод с таким кодом уже существует.</i>
ntf-promocode-created-success = <i>✅ Промокод успешно создан.</i>
ntf-promocode-updated-success = <i>✅ Промокод успешно обновлен.</i>
ntf-promocode-not-found = <i>❌ Промокод не найден.</i>
ntf-promocode-search-empty = <i>❌ Введите код для поиска.</i>
ntf-promocode-activated-success = <i>✅ Промокод успешно активирован! Вам предоставлена скидка { $percent }% на покупки.</i>
ntf-promocode-expired = <i>❌ Срок действия промокода истёк.</i>
