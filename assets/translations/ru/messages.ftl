...
ntf-remnatgseller-info = 
    ...
    Бот для продажи VPN-подписок. Работает с панелью Remnawave.

    ⭐ <i>Исходный код на <a href="{ $repository }">GitHub</a>. Поддержка и обновления — в нашем <a href="{ $community_url }">Telegram</a>.</i>


# Menu
msg-main-menu =
    <i>🔒 Быстрый и надёжный VPN. Поддержка 24/7.</i>
...
msg-menu-devices =
    ...
    <i>Чтобы добавить устройства — нажмите кнопку «Докупить устройства» ниже.</i>
...
msg-help-main =
    ...
    <blockquote>
    После оплаты нажмите кнопку «Подключиться», откройте страницу с конфигурацией. Скачайте приложение (V2Ray, Clash, Nekoray и др.) и импортируйте конфиг или отсканируйте QR-код.
    </blockquote>

    <b>Как добавить устройства?</b>
    <blockquote>
    Перейдите в «Мои устройства» и нажмите «Докупить устройства». Выберите нужное количество и оплатите.
    </blockquote>

    <b>Проблемы с подключением?</b>
    <blockquote>
    Проверьте, что подписка активна и не истекла. Попробуйте другой сервер в приложении. Если не помогло — напишите в поддержку.
    </blockquote>

    <b>Поддержка:</b> нажмите кнопку «Поддержка» в главном меню.
...
# RemnatgSeller
msg-remnatgseller-main = <b>🛍 RemnatgSeller v{ $version }</b>
...
msg-subscription-add-devices =
    ...
    Выберите количество устройств для добавления — нажмите на одну из кнопок ниже.

msg-subscription-add-devices-empty =
    <b>➕ Докупка устройств</b>

    В данный момент добавление устройств недоступно. Обратитесь в поддержку.

msg-subscription-promocode =
    <b>🎟 Активация промокода</b>

    Введите код промокода в сообщении ниже. Скидка будет применена к вашим следующим покупкам.

msg-subscription-new-success = 
    Чтобы начать пользоваться нашим сервисом:
    <blockquote>
    1️⃣ Нажмите кнопку <code>`{ btn-subscription-connect }`</code> выше
    2️⃣ Скачайте приложение (V2Ray, Clash, Nekoray и др.) — ссылки в нашем канале
    3️⃣ Импортируйте конфигурацию или отсканируйте QR-код из открывшейся страницы
    </blockquote>
...
msg-promocodes-search-results = <b>🔍 Результаты поиска</b>
...
msg-promocode-code = <b>🏷️ Код промокода</b>
    ...
    Отправьте новый код одним сообщением (латиница и цифры).
msg-promocode-type-select = <b>🔖 Тип награды</b>

    Выберите тип:
msg-promocode-availability-select = <b>✴️ Доступ</b>

    Кому доступен промокод:
msg-promocode-reward = <b>🎁 Награда</b>

    Тип: { promocode-type }
msg-promocode-reward-numeric-hint =
    Введите целое число: дни (длительность), ГБ (трафик), количество устройств или процент скидки — в зависимости от типа награды.
msg-promocode-reward-subscription =
    Нажмите <b>«Выбрать план»</b>, затем укажите план и срок (если у плана несколько вариантов).
msg-promocode-plan-pick = <b>💳 План для награды</b>

    Выберите активный план:
msg-promocode-plan-duration = <b>⌛ Срок подписки</b>

    План: <b>{ $plan_name }</b>

    Выберите длительность:
msg-promocode-plan-duration-missing =
    Нет вариантов срока для этого плана. Вернитесь назад и выберите другой план.
msg-promocode-lifetime = <b>⌛ Срок действия</b>

    Введите срок в <b>днях</b>. Укажите <b>-1</b> для бессрочного промокода.
msg-promocode-activations = <b>🔢 Лимит активаций</b>

    Сколько раз можно активировать промокод. Укажите <b>-1</b> для безлимита, или целое число ≥ 0.
msg-promocode-allowed-placeholder = <b>👥 Разрешённые пользователи</b>

msg-promocode-delete-confirm =
    <b>🗑 Удаление промокода</b>

    Удалить промокод <code>{ $delete_promocode_code }</code>? Это действие нельзя отменить.

    Настройка списка пользователей для режима доступа «Для разрешённых» пока не подключена к базе данных. Вернитесь в конфигуратор.
