...
msg-device-addons-main =
    ...
    Пакеты и цены по валютам настраиваются в БД (сид миграции). Здесь можно включать и отключать пакеты.

msg-device-addons-empty = <b>📱 Докупка устройств</b>

    <i>Пакетов пока нет. Выполните миграции БД или добавьте записи в таблицу <code>device_addons</code>.</i>
