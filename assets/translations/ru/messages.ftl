...
msg-locations-main =
    ...
    Доступные локации для подключения:

msg-locations-empty =
    <b>🌍 Серверы</b>

    Список серверов временно недоступен. Обратитесь в поддержку.
...
msg-help-main =
    ...
    <blockquote>
    Проверьте, что подписка активна и не истекла. Попробуйте другой сервер из списка «Серверы». Если не помогло — напишите в поддержку.
    </blockquote>
