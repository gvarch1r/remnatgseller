...
msg-device-addons-admin =
    ...
    { $addons_empty ->
    [1] <i>Пакетов пока нет. Нажмите «Добавить пакет» или выполните миграции БД (сид в миграции).</i>
    *[0] Добавляйте пакеты кнопкой ниже. В списке можно включать, отключать и удалять пакеты.
    }
